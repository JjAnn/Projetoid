class LocalsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @local.update(local_params)
        format.html { redirect_to clienta_path, notice: 'Local was successfully updated.' }
  ...
  def destroy
    @local.destroy
    respond_to do |format|
      format.html { redirect_to clienta_path, notice: 'Local was successfully destroyed.' }
