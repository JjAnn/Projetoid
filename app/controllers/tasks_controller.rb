...
@task = Task.new(task_params)
  ...
  def update
    respond_to do |format|
      if @task.update(task_params)
        format.html { redirect_to projetopo_path, notice: 'Task was successfully updated.' }
  ...
  def destroy
    @task.destroy
    respond_to do |format|
      format.html { redirect_to edit_projeto_path, notice: 'Task was successfully destroyed.' }
